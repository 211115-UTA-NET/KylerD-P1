    ...
    public class CustomerOrder
    {
        ...
        public static void StoreSelection(int myUserID)
        {
            ...
            while (exit == false)
            {
                ...
                try
                {
                    SpiceItUpDataStorage.SqlRepository.PrintStoreList();
                }
                catch (Exception)
                {
        ...
        public static void PullStoreInfo()
        {
            ...
            storeName = SpiceItUpDataStorage.SqlRepository.GetStoreName(storeEntry);

            //Begin pulling the inventory from the selected store and storing the info in lists
            itemIDList = SpiceItUpDataStorage.SqlRepository.GetStoreInventoryItemID(storeEntry);
            itemNameList = SpiceItUpDataStorage.SqlRepository.GetStoreInventoryItemName(storeEntry);
            inStockList = SpiceItUpDataStorage.SqlRepository.GetStoreInventoryInStock(storeEntry);
            priceList = SpiceItUpDataStorage.SqlRepository.GetStoreInventoryPrice(storeEntry);
        }
        ...
        public static void FinalizeTransaction()
        {
            ...
            try
            {
                SpiceItUpDataStorage.SqlRepository.FinalizeTransaction(itemIDList, inStockList, storeEntry, transID, userID, customerItemID, customerQuantity, customerPrice);
