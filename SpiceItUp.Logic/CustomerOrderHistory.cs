    ...
    public class CustomerOrderHistory
    {
        ...
        public static void CustomerTransactionHistory(int myUserID)
        {
            ...
            while (exit == false)
            {
                ...
                try
                {
                    transList = SpiceItUpDataStorage.SqlRepository.CustomerTransactionHistory(myUserID);
                }
                catch (Exception)
                {
                ...
                while (true)
                {
                    ...
                    {
                        SpiceItUpDataStorage.SqlRepository.DetailedTransaction(userEntry); //View the transaction in more detail
                        break;
                    }
